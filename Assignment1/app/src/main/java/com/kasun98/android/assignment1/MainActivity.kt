...
import com.kasun98.android.assignment1.databinding.ActivityMainBinding
...
//    override fun passDataCom(user: ArrayList<String>) {
//
//        val bundle = Bundle()
//        bundle.putStringArrayList("details",user)
//
